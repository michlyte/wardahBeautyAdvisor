...
import com.gghouse.wardah.wardahba.screen.calendar.retrofit.RetrofitProvider;
...
public class CalendarActivity extends RxAppCompatActivity {
    ...
    public static final SimpleDateFormat DAY_FORMAT = new SimpleDateFormat("yyyyMMdd", Locale.getDefault());
    public static final SimpleDateFormat YEAR_MONTH_FORMAT = new SimpleDateFormat("MMM yyyy", Locale.getDefault());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarListView.setWeekBar(initWeekBar());
    ...
    /**
     * Copied from the library to change the week language from Mandarin to English
     */
    private LinearLayout initWeekBar() {
        LinearLayout weekBar = (LinearLayout) findViewById(R.id.week_bar);
