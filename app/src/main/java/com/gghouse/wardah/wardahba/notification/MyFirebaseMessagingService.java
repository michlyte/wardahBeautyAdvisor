package com.gghouse.wardah.wardahba.notification;
...
//    }
    ...
    private void sendNotification(String messageTitle, String messageBody) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(WardahApp.getInstance().getAppContext().getResources(),
    ...
    private void broadcastLocalIntent() {
        ...
        intent.setAction(WBAIntent.NOTIF);
